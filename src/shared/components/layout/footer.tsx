    ...
    <footer className="border-t border-border bg-background pt-16 pb-8">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-16">
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-muted-foreground text-sm leading-relaxed max-w-sm">
              Premium, open-source utilities for your daily workflow. Built with privacy in mind – all processing
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-muted-foreground">
              <li>
                <Link to="/pdf-to-image" className="hover:text-primary transition-colors">
                  PDF to Image
                </Link>
              </li>
              <li>
                <Link to="/image-converter" className="hover:text-primary transition-colors">
                  Image Converter
                </Link>
              </li>
              <li>
                <Link to="/pdf-tools" className="hover:text-primary transition-colors">
                  Merge PDF
                </Link>
              </li>
              <li>
                <Link to="/image-tools" className="hover:text-primary transition-colors">
                  Resize Image
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <p className="text-xs text-muted-foreground mt-4 leading-relaxed">
              Master your knowledge with <span className="text-primary font-medium">new quizzes daily</span> across all
              categories.
            </p>
          </div>
        </div>
        ...
        <div className="border-t border-border pt-8 grid grid-cols-1 md:grid-cols-3 gap-4 items-center text-center md:text-left">
          <p className="text-sm text-muted-foreground">© {new Date().getFullYear()} Toolbox. Open source.</p>
