...
export function HowItWorks({ title = "How it works", description, steps, className }: HowItWorksProps) {
  return (
    <div className={cn("w-full", className)}>
      <h3 className="text-balance text-2xl font-bold tracking-tight text-foreground mb-2">{title}</h3>
      {description && <p className="max-w-2xl text-muted-foreground mb-8">{description}</p>}
