...
const FAQ_ITEMS = [
  {
    ...
    answer: "Yes. Conversion happens entirely in your browser. After the first load, it can work without an internet connection."
  },
  {
  ...
  },
  {
    ...
    answer: "Large PDFs with many pages or high-resolution images can take longer to process since everything is happening on your computer's processor. Try selecting a specific range of pages or converting in batches."
  }
];
